/*
 * Minimal RootHerald integration on Linux.
 *
 ...
 *
 * Run:
 *   ROOTHERALD_API_KEY=rh_pk_live_xxx ./build/sample-min-linux/rh_minimal
 */
...
int main(void) {
    ...
    RootHeraldClient* client = RootHeraldClient_Create(api_key, /*endpoint=*/NULL);
    if (!client) {
